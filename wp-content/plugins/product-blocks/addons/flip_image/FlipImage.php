...
class FlipImage {
    public function __construct() {
        $this->settings = wopb_function()->get_setting();
        add_action('wp_enqueue_scripts', array($this, 'add_flip_image_scripts'));
        if ( isset( $this->settings['flip_image_source'] ) && $this->settings['flip_image_source'] == 'feature' ) {
    ...
    public function add_flip_image_scripts() {
        ...
        wp_enqueue_script('wopb-flip-image-script', WOPB_URL . 'addons/flip_image/js/flip_image.js', array('jquery'), WOPB_VER);
    }
