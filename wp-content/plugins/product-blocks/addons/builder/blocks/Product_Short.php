...
class Product_Short{
    ...
    public function get_attributes() {
        return array(
            'blockId' => '',
            'previews' => '',
            'shortAlign' => (object) array('lg' => 'left'),
            'shortColor' => '',
            'shortTypo' => (object) array('openTypography' => 0,'size' => (object) array('lg' => '','unit' => 'px'),'height' => (object) array('lg' => '','unit' => 'px'),'decoration' => 'none','transform' => '','family' => '','weight' => ''),
