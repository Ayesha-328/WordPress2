    ...
    function set_data($arr = [], $font_name='') { ?>
        <div class="wopb-custom-font-container wopb-custom-font<?php echo empty($arr) ? '-copy' : ''; ?>">
            <div class="wopb-custom-font-heading">
                <div>
                    <label class="font-label"><?php echo esc_html__('Weight:  ', 'product-blocks'); ?> <span class="wopb-custom-font-weight"> <?php echo esc_html__(isset($arr['weight']) ? $arr['weight'] : '', 'product-blocks'); ?> </span></label>
                    <select name="weight[]">
