...
class Quickview
{
    ...
    public function add_quickview_scripts()
    {
        ...
        wp_enqueue_script('wopb-quickview', WOPB_URL . 'addons/quick_view/js/quickview.js', array('jquery', 'wp-api-fetch'), WOPB_VER);
    ...
    ?>
        ...
        >
            ...
            <?php echo $this->quick_view_content($params) ?>
        </div>
        ...
        <?php
            ...
            if ( wopb_function()->get_setting('quick_view_product_navigation') == 'yes' && $params['post_list'] ) {
                echo $this->quick_view_navigation($params);
            }
        die();
    }
                    ...
                    <div class="wopb-quick-view-btn-image">
                        <?php
                            if ( $thumbnail ) {
                                ...
                                if ( isset( $t_img[0] ) ) {
                        ?>
                            <img src="<?php echo $t_img[0] ?>" alt="<?php echo  get_the_title($key) ?>" />
                        <?php } } ?>
        ...
        <div class="wopb-main-section">
            <?php
                if( in_array('image', $content_keys) ) {
                    echo $this->quick_view_image($params, $product);
                }
            ?>
                            ...
                            switch ( $content['key'] ) {
                                ...
                                ?>
                                    <div class="wopb-rating-info">
                                        <?php
                                            woocommerce_template_single_rating();
                                            echo $this->stock_status($product);
                                        ?>
                                    </div>
                                <?php
                                    }
                                ...
                                case 'price':
                                    if( $product->get_price() ) {
                                        ...
                                        if ( $save_percentage ) {
                                            echo '<span class="wopb-discount-percentage">' . $save_percentage . '</span>';
                                        }
                                        echo "</div>";
                                    }
                                    break;
                                ...
                                case 'meta':
                                    ...
                                    break;
                                case 'view_details':
                                    echo '<a class="wopb-product-details" href="' . $product->get_permalink() . '">' . esc_html__( "View Full Product Details", "product-blocks" ) . '</a>';
                                    break;
                                case 'social_share':
                                    echo $this->social_share($product);
                                    break;
                                default;
                                    break;
                            }
...
<?php
    ...
    ?>
        <div>
            ...
            >
                <?php echo __('Buy Now', 'product-blocks') ?>
            </a>
        </div>
    <?php
    }
        ...
        <div class="wopb-quick-view-image <?php echo esc_attr($image_wrapper_class); ?>">
            ...
            ?>
                <div class="wopb-quick-view-gallery <?php echo esc_attr( $image_class ) ?>">
                    <div class="wopb-thumbnail">
                        ...
                        <?php if ( $save_percentage ) { ?>
                            <span class="wopb-quick-view-sale">-
                                <span><?php echo __('Sale!', 'product-blocks'); ?></span>
                            </span>
                        <?php } ?>
                    </div>
                    <?php
                    ...
                    ?>
                        <div
                            class="wopb-quick-slider-nav<?php echo $nav_class ?>"
                            data-arrow="true"
                            data-collg="4"
                            data-colmd="4"
                            data-colsm="2"
...
<?php
    ...
    ?>
        <div class="wopb-product-social-share">
            <span><?php echo __('Social Share','product-blocks'); ?></span>
    ...
    public function quick_view_button() {
        ...
        echo wopb_function()->get_quick_view($params);
    }
    ...
    public function header_element() {
        ...
        if ( $quick_view_css ) {
            ...
            echo '<style id="wopb-quickview-internal-style">' . $quick_view_css . '</style>';
        }
    }
    ...
    public function zoom_icons($key='') {
        $icons = array(
            'zoom_1' => file_get_contents(WOPB_PATH.'assets/img/addons/quick_view/cursor_zoom_1.svg'),
            'zoom_2' => file_get_contents(WOPB_PATH.'assets/img/addons/quick_view/cursor_zoom_2.svg'),
        );
        return $key ? $icons[$key] : $icons;
    }
