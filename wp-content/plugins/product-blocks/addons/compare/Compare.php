...
class Compare {
    ...
    public function compare_clear() {
        if ( isset($_GET['wopb_compare_clear']) && isset($_COOKIE['wopb_compare']) ) {
    ...
    public function wopb_compare_callback() {
        ...
        if ( $postId && $action_type ) {
            ...
            setcookie('wopb_compare', json_encode($data_id), time()+604800, '/'); // 7 Days
                    ...
                    <div class="wopb-compare-item wopb-compare-item-<?php echo esc_attr($product->get_id()) ?>">
                        <div class="wopb-compare-product-details">
                            ...
                            <div class="wopb-compare-product-content">
                                <div class="wopb-compare-product-name"><?php _e($product->get_title(), 'product-blocks'); ?></div>
...
?>
        ...
        >
            ...
            ?>
                    <table class="wopb-compare-table">
                        <thead>
                            <tr class="<?php echo $row_class ?>">
                                <th class="<?php echo $column_class ?>"><?php _e('Action' ,' product-blocks'); ?></th>
                                <?php
                                ...
                                ?>
                                        <td class="wopb-compare-item wopb-compare-item-<?php echo esc_attr($product->get_id()) ?>">
                                            <a class="wopb-compare-remove" data-action="remove" data-added-action="popup" data-postid="<?php echo esc_attr($product->get_id()) ?>">
                                                ...
                                                <span><?php _e('Delete' ,' product-blocks'); ?></span>
                                            </a>
                                        </td>
                                <?php
                                    }
                                ...
                                ?>
                                    <td class="wopb-action-add-btn">
                                        <a class="wopb-compare-add-btn">
                                            ...
                                            <span class="wopb-tooltip"><?php _e('Add Product', 'product-blocks'); ?></span>
                                        </a>
                                    </td>
                                <?php } ?>
                            </tr>
                    ...
                    ?>
                            <tr class="<?php echo $row_class ?>">
                                <th class="<?php echo $column_class ?>"><?php esc_html_e($table_column['label'], 'product-blocks') ?></th>
                                <?php
                                    foreach ($compare_data as $key => $val) {
                                        $product = wc_get_product($val);
                                ?>
                                        <td class="wopb-compare-item-<?php echo esc_attr($product->get_id()) ?>">
                                            ...
                                            ?>
                                                    <span class="wopb-cart-action">
                                                        ...
                                                        >
                                                            <?php esc_html_e($cart_text, 'product-blocks'); ?>
                                                        </a>
                                                        <a
                                            ...
                                            ?>
                                                        <div class="wopb-review-content">
                                                            ...
                                                            <span class="wopb-review-count">
                                                                <?php esc_html_e($product->get_rating_count() . ' customer review', 'product-blocks');?>
                                                            </span>
                                                        </div>
                                            <?php
                                                    break;
                                ...
                                <?php
                                    ...
                                    for ($i = 0; $i < $demo_column; $i++) {
                                        ...
                                        if ( $table_column['key'] == 'image' ) {
                                            ...
                                            $demo_content = file_get_contents(WOPB_PATH . 'assets/img/svg/placeholder.svg');
                                        }
            ...
            <div class="wopb-product-list-content">
                ...
                <div class="wopb-product-list-body">
                    <div class="wopb-product-search">
                        <input type="text" class="wopb-search-input" placeholder="<?php _e('Search for products by name...', 'product-blocks'); ?>">
...
?>
        ...
        ?>
                <div class="wopb-compare-item wopb-compare-item-<?php echo esc_attr($product->get_id()) ?>">
                    ...
                    <div class="wopb-compare-product-name"><span><?php _e($product->get_title(), 'product-blocks'); ?></span> <?php _e('has been added on compare list', 'product-blocks'); ?>.</div>
                </div>
        <?php } ?>
            <a
            ...
            >
                <?php _e('View Compare List', 'product-blocks'); ?>
            </a>
<?php
        return ob_get_clean();
    }
