...
class Notice {
	...
	public function get_notice_content( $key, $design_type ) {
		...
		switch ( $design_type ) {
			case 'pro_4':
				...
				$url         = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=massive_discount_pro&utm_campaign=productx-dashboard';
				$full_access = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=massive_discount_access&utm_campaign=productx-dashboard';
			...
			case 'pro_2':
				// User Get Free User
				$icon     = WOPB_URL . 'assets/img/logo-sm.svg';
				$url      = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=special_discount_pro&utm_campaign=productx-dashboard';
				$discount = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_setting_footer&utm_medium=get_special_discount&utm_campaign=productx-dashboard';
			...
			case 'pro_3':
				// Will Get single
				$url = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=special_offer_access&utm_campaign=productx-dashboard';
				ob_start();
				?>
			...
			case 'pro_1':
				...
				$icon = WOPB_URL . 'assets/img/logo-sm.svg';
				$url  = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=templates_pro&utm_campaign=productx-dashboard';

				$access_url = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=templates_access&utm_campaign=productx-dashboard';
				ob_start();
				?>
			...
			case 'lifetime_n_unlimited_1':
				...
				// Lifetime and Ultimited
				$icon = WOPB_URL . 'assets/img/logo-sm.svg';
				$url  = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=unlimited_yearly_to_unlimited_lifetime_pro&utm_campaign=productx-dashboard';

				$lifetime_url = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=unlimited_yearly_to_unlimited_lifetime_access&utm_campaign=productx-dashboard';
				ob_start();
				?>
			...
			case 'lifetime_1':
				// Lifetime 1
				$icon = WOPB_URL . 'assets/img/logo-sm.svg';
				$url  = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=single_yearly_to_single_lifetime_pro&utm_campaign=productx-dashboard';
				$pro_url  = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=single_yearly_to_single_lifetime_access&utm_campaign=productx-dashboard';
			...
			case 'lifetime_2':
				...
				$icon                  = WOPB_URL . 'assets/img/logo-sm.svg';
				$url                   = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=single_yearly_to_unlimited_site_yearly_pro&utm_campaign=productx-dashboard';
				$unlimited_site_access = 'https://www.wpxpo.com/productx/pricing/?utm_source=productx_topbar&utm_medium=single_yearly_to_unlimited_site_yearly_access&utm_campaign=productx-dashboard';
	...
	public function is_valid_notice( $notice ) {
		...
		$current_time = date( 'U' ); // Todays Data
	...
	public function set_promotional_notice_callback() {
		if ( isset( $_GET['wopb-data-collect'] ) ) {
			$notice_key = sanitize_text_field( $_GET['wopb-data-collect'] );
		...
		if ( isset( $_GET['wopb-notice-disable'] ) ) {
			$notice_key = sanitize_text_field( $_GET['wopb-notice-disable'] );
			$notice     = $this->get_notice_by_id( $notice_key );
			if ( 'data_collect' == $notice['type'] ) {
