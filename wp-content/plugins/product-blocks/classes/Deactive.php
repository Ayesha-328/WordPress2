...
class Deactive {
	...
	public static $PLUGIN_NAME = 'ProductX';
	public static $PLUGIN_SLUG = 'product-blocks';
	public static $PLUGIN_VERSION = WOPB_VER;
    ...
    public function __construct() {
		...
		add_action( 'wp_ajax_wopb_deactive_plugin',  array(__CLASS__,'send_plugin_data')  );
                ...
                <div class="wopb-modal-body">
                    ...
                    <ul class="wopb-modal-input">
						<?php foreach ($this->get_settings() as $key => $setting) { ?>
							<li>
								<label>
									<input type="radio" <?php echo ($key == 0 ? 'checked="checked"' : ''); ?> id="<?php esc_attr_e($setting['id']); ?>" name="<?php esc_attr_e(self::$PLUGIN_SLUG); ?>" value="<?php esc_attr_e($setting['text']); ?>">
