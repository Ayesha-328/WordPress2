...
class Product_Grid_2{
    ...
    public function get_attributes() {
        return array (
            ...
            'reviewMargin' => (object) array('lg' => (object) array('top' => 10,'bottom' => 0,'unit' => 'px')),
            'shortDescLimit' => 7,
            ...
            'cartTypo' => (object) array('openTypography' => 1,'size' => (object) array('lg' => 12,'unit' => 'px'),'height' => (object) array('lg' => '24','unit' => 'px'),'spacing' => (object) array('lg' => 0,'unit' => 'px'),'transform' => 'uppercase','weight' => '600','decoration' => 'none','family' => ''),
            'cartColor' => '#fff',
            ...
            'cartRadius' => (object) array('lg' => '2','unit' => 'px'),
            'cartHoverColor' => '#fff',
            ...
            'cartHoverRadius' => (object) array('lg' => '2','unit' => 'px'),
            'cartSpacing' => (object) array('lg' => (object) array('top' => 20,'bottom' => '','left' => '','right' => '','unit' => 'px')),
            'cartPadding' => (object) array('lg' => (object) array('top' => '5','bottom' => '5','left' => '12','right' => '12','unit' => 'px')),
            'enableCatLink' => true,
            'catPosition' => 'none',
                                                    ...
                                                    $image_data .= '<div class="wopb-product-meta">';
                                                        ...
                                                        if ( $attr["layout"] == '3' || $attr["layout"] == '4' || $attr["layout"] == '5' || $attr["layout"] == '6' ) {
                                                            ...
                                                            if ( $attr["showCompare"] && $compare ) {
                                                                $image_data .= wopb_function()->get_compare($post_id, ['layout' => $attr["layout"], 'position' => array(3, 4)]);
                                                            }
                                                            if ( ( $attr["layout"] == '4' || $attr["layout"] == '5' || $attr["layout"] == '6' ) && $attr["showCart"] ) {
                                                                $image_data .= wopb_function()->get_add_to_cart($product, $attr['cartText'], $attr['cartActive'], $attr['layout'], array(3, 4), $attr);
                                                            }
                                                        }
                                                    $image_data .= '</div>';
                                                    }
                                                            ...
                                                            if ( $attr["layout"] == '2' ) {
                                                                if ( $attr["quickView"] && $quickview ) {
                                                                    ...
                                                                    $content_data .= '<div class="wopb-quickview-btn">';
                                                                        $content_data .= wopb_function()->get_quick_view($quick_params);
                                                                    $content_data .= '</div>';
                                                                }
                                                                if ( $attr['showCart'] ) {
                                                                    $content_data .= wopb_function()->get_add_to_cart($product, $attr['cartText'], $attr['cartActive'], $attr['layout'], array(), false, $attr);
                                                                ...
                                                                if ( $attr["showCompare"] && $compare ) {
                                                                    $content_data .= '<div class="wopb-compare-btn">';
                                                                        $content_data .= wopb_function()->get_compare($post_id, ['layout' => $attr["layout"], 'position' => array(3, 4)]);
                                                                    $content_data .= '</div>';
                                                                }
                                                            }
                                                        $content_data .= '</div>';
