...
class Filter {
    ...
    public function get_attributes() {
        return array (
            ...
            'labelColor' => '#474747',
            'labelTypo' => (object) array('openTypography' => 1,'size' => (object) array('lg' => '','unit' => 'px'),'height' => (object) array('lg' => '','unit' => 'px'),'decoration' => 'none','transform' => '','family' => '','weight' => ''),
            'togglePlusMinus' => true,
            'togglePlusMinusInitialOpen' => true,
            'togglePlusMinusSize' => (object) array('lg' => '17','unit' => 'px'),
            'togglePlusMinusColor' => '#373737',
            'searchBoxColor' => '#3b3b3b',
            'searchBoxBackgroundColor' => '#fff',
            'searchBoxBorder' => (object) array('openBorder' => 1,'width' => (object) array('top' => 1,'right' => 1,'bottom' => 1,'left' => 1),'color' => '#9c9c9c','type' => 'solid'),
            'searchBoxRadius' => (object) array('lg' => '4','unit' => 'px'),
            'searchBoxPadding' => (object) array('lg' => (object) array('top' => '6','bottom' => '6','left' => '12','right' => '12','unit' => 'px')),
...
?>
        <div class="wopb-taxonomy-relation">
            <div class="wopb-relation-heading"><?php _e('Taxonomy Relation', 'product-blocks'); ?></div>
            <div class="wopb-filter-body">
