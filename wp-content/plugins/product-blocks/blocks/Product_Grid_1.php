...
class Product_Grid_1{
    ...
    public function get_attributes() {
        return array (
            ...
            'pricePadding' => (object) array('lg' => (object) array('top' => 4,'bottom' => 0,'unit' => 'px')),
            'saleText' => 'Sale!',
            ...
            'titlePadding' => (object) array('lg' => (object) array('top' => 4,'bottom' => 0,'unit' => 'px')),
            'cartText' => '',
            'cartActive' => 'View Cart',
            'cartTypo' => (object) array('openTypography' => 1,'size' => (object) array('lg' => 11,'unit' => 'px'),'height' => (object) array('lg' => '15','unit' => 'px'),'spacing' => (object) array('lg' => 0,'unit' => 'px'),'transform' => 'uppercase','weight' => '600','decoration' => 'none','family' => ''),
            'cartColor' => '#ff5845',
            'cartBgColor' => (object) array('openColor' => 0,'type' => 'color','color' => ''),
            'cartBorder' => (object) array('openBorder' => 1,'width' => (object) array('top' => 1,'right' => 1,'bottom' => 1,'left' => 1),'color' => '#ff5845','type' => 'solid'),
            'cartRadius' => (object) array('lg' => '0','unit' => 'px'),
            'cartHoverColor' => '#fff',
            'cartBgHoverColor' => (object) array('openColor' => 1,'type' => 'color','color' => '#ff5845'),
            'cartHoverBorder' => (object) array('openBorder' => 1,'width' => (object) array('top' => 1,'right' => 1,'bottom' => 1,'left' => 1),'color' => '#ff5845','type' => 'solid'),
            'cartHoverRadius' => (object) array('lg' => '0','unit' => 'px'),
            'cartSpacing' => (object) array('lg' => (object) array('top' => 12,'bottom' => '','left' => '','right' => '','unit' => 'px')),
            ...
            'catPadding' => (object) array('lg' => (object) array('top' => '4','bottom' => '4','left' => '0','right' => '0','unit' => 'px')),
            ...
            'imgMargin' => (object) array('lg' => (object) array('top' => '0','right' => '0','bottom' => '10','left' => '0','unit' => 'px')),
