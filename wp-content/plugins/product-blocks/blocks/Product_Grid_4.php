...
class Product_Grid_4{
    ...
    public function get_attributes() {
        return array (
            ...
            'cartTypo' => (object) array('openTypography' => 1,'size' => (object) array('lg' => 12,'unit' => 'px'),'height' => (object) array('lg' => '20','unit' => 'px'),'spacing' => (object) array('lg' => 0,'unit' => 'px'),'transform' => 'uppercase','weight' => '600','decoration' => 'none','family' => ''),
            'cartColor' => '#fff',
            ...
            'cartPadding' => (object) array('lg' => (object) array('top' => '5','bottom' => '5','left' => '10','right' => '10','unit' => 'px')),
            'enableCatLink' => true,
            'catPosition' => 'none',
            ...
            'wishlistColor' => '#000',
            'wishlistHoverColor' => '#545454',
            'metaElementColor' => '#fff',
            'metaElementBg' => '#000',
            'metaElementBorder' => (object) array('openBorder' => 0,'width' => (object) array('top' => 1,'right' => 1,'bottom' => 1,'left' => 1),'color' => '#009fd4','type' => 'solid'),
            'metaElementRadius' => (object) array('lg' => '50','unit' => 'px'),
            'metaElementShadow' => (object) array('openShadow' => 1,'width' => (object) array('top' => 1,'right' => 1,'bottom' => 6,'left' => 2),'color' => '#e5e5e5'),
            'metaElementHoverColor' => '#fff',
            'metaElementHoverBg' => '#ff5845',
            ...
            'metaElementHoverShadow' => (object) array('openShadow' => 1,'width' => (object) array('top' => 1,'right' => 1,'bottom' => 6,'left' => 2),'color' => '#e5e5e5'),
            'metaElementSpacer' => (object) array('lg' => '10','unit' => 'px'),
            'metaElementPadding' => (object) array('lg' => (object) array('top' => '8','bottom' => '8','left' => '8','right' => '8','unit' => 'px')),
            'quickViewColor' => '#fff',
            'quickViewHoverColor' => '#fff',
            'quickViewBg' => '#444',
            'quickViewHoverBg' => '#ff5845',
            'quickViewPadding' => (object) array('lg' => (object) array('top' => '8','bottom' => '8','left' => '8','right' => '8','unit' => 'px')),
            'imgCrop' => 'full',
            ...
            'fliterSpacing' => (object) array('lg' => (object) array('top' => '','bottom' => '25','right' => '','left' => '20','unit' => 'px')),
